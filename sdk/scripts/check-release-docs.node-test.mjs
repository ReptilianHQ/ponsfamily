...
test("resolves the workflow-generated numbered RC manifest to its stable release line", () => {
  assert.equal(stableVersionFromManifest("0.1.1-rc.2"), "0.1.1");
});

for (const version of ["0.1.1-rc", "0.1.1-rc.01", "0.1.1-beta", "v0.1.1", "01.1.1"]) {
