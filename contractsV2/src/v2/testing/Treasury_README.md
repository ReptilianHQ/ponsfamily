...
```
$TREASURY: 0xdaeaabbc2e877c29b23afa8811c9a8e40c2cfccc
```
...
| Name | Purpose |
|---|---|
| `TREASURY_TOKEN` | `0xdaeaabbc2e877c29b23afa8811c9a8e40c2cfccc` -- $TREASURY, this standard's canonical asset. Always an allowed treasury holding; every asset-taking function has an overload that resolves to it automatically. |
...
address constant TREASURY = 0xdaeaabbc2e877c29b23afa8811c9a8e40c2cfccc; // $TREASURY
